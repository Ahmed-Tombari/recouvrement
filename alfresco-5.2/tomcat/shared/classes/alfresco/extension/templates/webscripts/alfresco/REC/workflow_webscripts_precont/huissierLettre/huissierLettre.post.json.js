...
if(action == "lettre recue"){
	
	taskId = result.get(0).id;
    ws.getTaskService().setVariable(taskId,"drpre_communicationAvecLeHuissierNotaireOutcome",action);
	...
	message = "lettre Recue";
    

}
else{

if(action == "lettre non recue"){
